  ...
  return (
    <>
      <Grid.Container className="m-0 p-0" gap={2}>
        ...
        >
          <Text className="f-size-sm" b>Delivery Details</Text>
          <MInput 
            value={"8472"}
            type="text"
        ...
        >
          <div className="mr-3">
            <Text className="f-size-sm">20 Products in Shopping Cart</Text>
            <Text className="f-size-sm"><strong>150</strong> plus VAT</Text>
          </div>
          <div>
            <Button 
              auto 
